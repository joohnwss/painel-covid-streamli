...
_CSS_LIGHT = (
    ...
    "[data-testid='stHeader']{background:#F6F8FB!important;border-bottom:1px solid #E2E8F0!important;}"
    "[data-testid='stToolbar']{display:none!important;}"
    "@media(min-width:768px){[data-testid='stHeader']{display:none!important;}}"
